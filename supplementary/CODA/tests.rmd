...
\begin{eqnarray}
  \log(\alpha_{1n}) & = & \eta_{1n} = \beta_{11} \cdot v_{1n} + w^1(j_n) \,, \nonumber \\
  \log(\alpha_{2n}) & = & \eta_{2n} = \beta_{12} \cdot v_{2n} + w^1(j_n) \,, \nonumber \\
  \log(\alpha_{3n}) & = & \eta_{3n} = \beta_{13} \cdot v_{3n} + w^2(j_n) \,, \nonumber \\
  \log(\alpha_{4n}) & = & \eta_{4n} = \beta_{14} \cdot v_{4n} + w^2(j_n) \,, \nonumber \\
\end{eqnarray}
